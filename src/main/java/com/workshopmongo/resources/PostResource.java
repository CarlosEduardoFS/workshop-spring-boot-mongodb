...
public class PostResource {
	...
	@RequestMapping(value = "/{id}", method = RequestMethod.GET) // diz que o caminho é users/id
	public ResponseEntity<Post> findById(@PathVariable String id) {
		Post obj = service.findById(id);
		return ResponseEntity.ok().body(obj);
	}
	
	@RequestMapping(value = "/titlesearch", method = RequestMethod.GET) // diz que o caminho é users/id
	...
	@RequestMapping(value = "/fullsearch", method = RequestMethod.GET) // diz que o caminho é users/id
